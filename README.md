...
```
bash <(curl -sL https://raw.githubusercontent.com/aleskxyz/reality/master/reality.sh)
```
...
![image](https://github.com/aleskxyz/reality/assets/39186039/a727148c-1a11-4702-80f3-ab8b46d916af)
...
<p align="center">
<img src="https://github.com/aleskxyz/reality/assets/39186039/7e31383a-e00b-426e-9324-6d58f36e7da0" width="300">
</p>

Help message of the script:
```

Usage: reality.sh [-t|--transport=tcp|http|grpc|ws|tuic|hysteria2|shadowtls] [-d|--domain=<domain>] [--server=<server>]
...
```
/opt/reality/sing-box.patch
```
or
```
/opt/reality/xray.patch
```
And run script to apply your changes.

For example if you want to increase the debug level of sing-box engine, you can create `/opt/reality/sing-box.patch` with this content:
```
{
  "log": {
    "level": "debug",
